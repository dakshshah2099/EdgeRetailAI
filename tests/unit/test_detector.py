...
from detection.detector import PERSON_CLASS_ID, PersonDetector
from detection.inference_backend import ONNXBackend, RawDetection

MODEL_PATH = Path("models/yolo26n.onnx")
BUS_IMAGE_PATH = Path("tests/fixtures/bus.jpg")
