...
**Generated:** 2026-09-10 03:22:27 UTC  
...
| **Mean Latency** | 28.73 ms | 48.81 ms | +69.9% latency increase (regression on CPU) |
| **Min Latency** | 26.65 ms | 46.15 ms | - |
| **Max Latency** | 35.18 ms | 52.55 ms | - |
| **95th Percentile (p95)** | 34.06 ms | 52.08 ms | - |
| **Throughput (FPS)** | 34.81 FPS | 20.49 FPS | 0.59x throughput (slowdown on generic CPU) |
...
1. **Local Host Performance:** Baseline FP32 achieves **34.81 FPS** (28.73 ms/frame) on the development laptop. Dynamic INT8 runs at **20.49 FPS** due to activation dequantization on CPU, while shrinking binary size for edge distribution.
